...
| M3 | `content-basics` | Populate all nine Language Basics sections with accurate, complete code examples (Variables, Functions, Classes, Interfaces, Generics, Errors, Async, Collections, Modules). | `in-progress` | `feat/content-basics` | All code examples must be syntactically correct. No pseudocode. |
